...
public class KBAuthHandler {
    ...
    public final static int KBAuthFailed = 1;
    public final static int KBAuthSuccess = 0;
    ...
    boolean authSendMd5Request(String macAddress, String password) {
        ...
        if (mConnPara != null)
        {
            ...
            int nIndex = 6;
            authRequest[nIndex++] = (byte)((mConnPara.utcTime >> 24) & 0xFF);
            authRequest[nIndex++] = (byte)((mConnPara.utcTime >> 16) & 0xFF);
            authRequest[nIndex++] = (byte)((mConnPara.utcTime >> 8) & 0xFF);
            authRequest[nIndex++] = (byte)(mConnPara.utcTime & 0xFF);
        }else{
    ...
    void authHandleResponse(byte[] byRcvNtfValue) {
        if (byRcvNtfValue.length < 1) {
            ...
            delegate.authStateChange(KBAuthFailed);
        }
        ...
        if (byRcvNtfValue[0] == AUTH_PHASE1_APP || byRcvNtfValue[0] == AUTH_MIN_MTU_ALOGRIM_PH1) {
            ...
            this.delegate.authStateChange(KBAuthSuccess);
